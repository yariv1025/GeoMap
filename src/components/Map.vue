  ...
  <div class="hero">
    ...
    <div>
      ...
      <p class="lead">A geographic information system (GIS) is a
        computer-based system used for collecting, storing, manipulating,
        and analyzing spatial data i.e data that can be referenced to a
  ...
  export default {
    ...
    methods: {
      ...
      initMap () {
        let latitude = 38.63
        let longitude = -90.23
        // const myMap = L.map('map_element').setView([latitude, longitude], 13)
        //
        ...
        //     tileSize: 512,
        //     zoomOffset: -1,
        //     accessToken: 'pk.eyJ1IjoieWFyaXYxMDUyIiwiYSI6ImNrbTMyaW54ajI4dW8ycHJ6ZG4yYzNlYzMifQ.iItWb3L0rWx90HZH5YWYoA'
        //   }).addTo(myMap)
        this.map = L.map('mapElement').setView([latitude, longitude], 12)
